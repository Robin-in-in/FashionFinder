  ...
  return (
    <section
      style={{
        ...
        color: "brown",                       // Dark brown text color
        fontFamily: "'Book Antiqua', serif",  // Book Antiqua font
        minHeight: "100vh",                   // Optional: full-page coverage
        padding: "2rem",                      // Optional: spacing around page
      }}
    >
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="space-y-1">
                      <Label htmlFor="email" className="px-2 py-1">Email</Label>
                      <Input
                        id="email"
                        type="email"
                        placeholder="Email"
                  ...
                  <div className="space-y-2">
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        {...register("password")}
                        className={
                          errors?.user?.password?.message ? "border-destructive" : ""
                        }
                      />
